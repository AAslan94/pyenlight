...
master_design_example = {
    "environment": {
        ...
        "special_surfaces": [
            ...
            #    "type": "RIS",
            #    "name": "Wall Reflector",
            #    "center": [5, 1.5, 1.5], # On the east wall (x=L)
            #    "dims": [2.0, 2.0],
           ...
           #     "center": [5, 3.5, 1.5], # On the east wall (x=L)
           #     "dims": [2.0, 2.0],
           #     "const_axis": 0,           # Constant on the X axis
           #     "resolution": [10, 10],
           #     "normal": [-1,0, 0],      # Pointing into the room (-y)
    ...
    "nodes": {
        ...
        "sensors": {
            "positions": generate_grid(0.2,4.8,0.2,4.8,0,8,8,False), 
...
master_1 = {
    "environment": {
        ...
        "blockers": {
            "positions": [
                [2.5, 1,0],
                [4,4,0],
                [1,2,0]# Position of Blocker 1 (e.g., a person standing in the middle)
            ],
    ...
    "nodes": {
        "masters": {
            ...
            "tx_power": 1.0,    # Downlink VLC Power (W)
            "sensitivity": -100,
            "IR_pass_filter": False
        },
        "sensors": {
            "positions": generate_grid(0.2,4.8,0.2,4.8,0.2,40,40,False), 
            "nT": [0, 0, 1],    # TX pointing up
