...
from enlight_iot.core.utils import solar_panel_angular_efficiency, calculate_blockage_mask, generate_microgrids_vectorized
from enlight_iot.environment.geometry import Room
