...
if __name__ == "__main__":
    ...
    if grid_side**2 != num_sensors:
        ...
        plt.tight_layout()
        plt.savefig("plots/a1/snr_d_pd.pdf", format="pdf", bbox_inches="tight")
        plt.show()
    ...
    if grid_side**2 != num_sensors:
        ...
        plt.tight_layout()
        plt.savefig("plots/a1/snr_d_diff.pdf", format="pdf", bbox_inches="tight")
        plt.show()
    ...
    if grid_side**2 != num_sensors:
        ...
        plt.tight_layout()
        plt.savefig("plots/a1/snr_u.pdf", format="pdf", bbox_inches="tight")
        plt.show()
    ...
    if grid_side**2 != num_sensors:
        ...
        plt.tight_layout()
        plt.savefig("plots/a1/snr_u_diff.pdf", format="pdf", bbox_inches="tight")
        plt.show()