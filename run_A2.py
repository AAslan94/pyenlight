...
from design_A2 import master_design_example 
...
if __name__ == "__main__":
    ...
    if grid_side**2 != num_sensors:
        ...
        plt.tight_layout()
        plt.savefig("plots/a2/snr_d_pv.pdf", format="pdf", bbox_inches="tight")
        plt.show()
    ...
    if grid_side**2 != num_sensors:
        ...
        plt.tight_layout()
        plt.savefig("plots/a2/bpv.pdf", format="pdf", bbox_inches="tight")
        plt.show()
    ...
    if grid_side**2 != num_sensors:
        ...
        plt.tight_layout()
        plt.savefig("plots/a2/hrf.pdf", format="pdf", bbox_inches="tight")
        plt.show()
