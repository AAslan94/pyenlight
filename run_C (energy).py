...
from design_C_energy import master_design_example 
...
def run_experiment(design_dict, run_name="exp_001", run_budget=False, btma_mode=False, **kwargs):
    ...
    em = EnergyManager(loaded_dto, design_dict, MAC=True, btma_mode=btma_mode, **kwargs)
...
if __name__ == "__main__":
    ...
    if grid_side**2 != num_sensors:
        ...
        plt.tight_layout()
        plt.savefig("plots/c1/snr_d_pd_b.pdf", format="pdf", bbox_inches="tight")
        plt.show()
    ...
    if grid_side**2 != num_sensors:
        ...
        plt.tight_layout()
        plt.savefig("plots/c1/snr_d_diff_b.pdf", format="pdf", bbox_inches="tight")
        plt.show()
    ...
    if grid_side**2 != num_sensors:
        ...
        plt.tight_layout()
        plt.savefig("plots/c1/snr_u_b.pdf", format="pdf", bbox_inches="tight")
        plt.show()
    ...
    if grid_side**2 != num_sensors:
        ...
        plt.tight_layout()
        plt.savefig("plots/c1/snr_u_diff_b.pdf", format="pdf", bbox_inches="tight")
        plt.show()