...
def main():
    ...
    if "ap_reachable" not in channel_signature.parameters:
        raise RuntimeError(
            ...
            "argument in VLC_Channel. Replace enlight_iot/network/mac.py "
            "with mac_collision_threshold_fixed.py before running."
        )
    ...
    cases = [
        ...
        {
            "case_name": r"BTMA: $10\%$ UL+DL blocked",
            "mac_enabled": True,
            "btma_mode": True,
            "blocked_fraction": BLOCKED_FRACTION,
            "blockage_mode": "both",
        ...
        {
            "case_name": r"BTMA: $10\%$ DL-only blocked",
            "mac_enabled": True,
            "btma_mode": True,
            "blocked_fraction": BLOCKED_FRACTION,
